...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    await sql`INSERT INTO analyses (id, user_id, analysis_type, input_excerpt, result_json) VALUES (${crypto.randomUUID()}, ${session.userId}, 'feed', ${feedContent.slice(0, 300)}, ${JSON.stringify(result)}::jsonb)`;
